...
GameState::GameState()
    ...
    // Spawn ONLY wave 10 dragon boss for testing
    std::cout << "Spawning Wave 10 dragon boss for testing at center...\n";
    spawnEnemyInternal(400.0f, 300.0f, 0, true, true);   // Dragon boss at center
}
